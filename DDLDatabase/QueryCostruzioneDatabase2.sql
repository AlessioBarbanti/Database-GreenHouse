...
create table CLUSTER_EMBRIONI (
     ...
     constraint CHK_DATA_CLUSTER_EMBRIONI check (DataSemina < DataGerminazione and DataGerminazione<DataUscita),
...
create table CLUSTER_PIANTE (
     ...
     IDEsperimento int not null,
     IDPianta int not null,
     constraint CHK_DATA_CLUSTER_PIANTE check (DataInizio<=DataTrapianto and DataInizio<DataEspianto and DataInizio<DataFine and DataInizio < DataSmaltimento
...
create table ESPERIMENTI (
     ...
     constraint CHK_DATA_ESPERIMENTI check (DataInizio<DataFine and DataInizio>DataApprovazione and DataApprovazione<DataFine),
...
create table IRRIGAZIONI (
     ...
     constraint CHK_DATA_IRRIGAZIONI check (DataInizio<=DataFine and OraInizio<OraFine),
...
create table LAVORI_EFFETTUATI (
     ...
     constraint CHK_DATA check (DataOraInizio<=DataOraFine),
